...
class FixtureService {
     ...
     */
    static generateFixtures(options) {
     ...
     */
    static generateKnockout(event, registrations) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const createMatch = (round, matchNum, pA, pB, nextMatchId) => __awaiter(this, void 0, void 0, function* () {
                ...
                return db_1.prisma.match.create({
                    data: {
                        eventId: event.id,
                        round,
                        matchNumber: matchNum,
                        playerAId: pA === null || pA === void 0 ? void 0 : pA.id,
                        playerBId: pB === null || pB === void 0 ? void 0 : pB.id,
                        status: (pA && pB) ? client_1.MatchStatus.PENDING : client_1.MatchStatus.COMPLETED, // If missing player, it's a bye/auto-win
            ...
            const roundMatches = {};
            // Create Final
            const finalMatch = yield db_1.prisma.match.create({
                data: { eventId: event.id, round: totalRounds, matchNumber: 1, status: client_1.MatchStatus.PENDING }
            });
            ...
            for (let r = totalRounds - 1; r >= 1; r--) {
                ...
                for (const nextMatch of nextRoundMatches) {
                    ...
                    const m1 = yield db_1.prisma.match.create({
                        data: { eventId: event.id, round: r, matchNumber: nextMatch.matchNumber * 2 - 1, nextMatchId: nextMatch.id, status: client_1.MatchStatus.PENDING }
                    });
                    const m2 = yield db_1.prisma.match.create({
                        data: { eventId: event.id, round: r, matchNumber: nextMatch.matchNumber * 2, nextMatchId: nextMatch.id, status: client_1.MatchStatus.PENDING }
                    });
            ...
            for (const match of round1Matches) {
                ...
                const updateData = {};
                if (pA)
                    updateData.playerAId = pA.id;
                if (pB)
                    updateData.playerBId = pB.id;
                // Auto-win logic
                if (pA && !pB) {
                    updateData.winnerId = pA.id;
                    updateData.status = client_1.MatchStatus.COMPLETED;
                    ...
                    updateData.status = client_1.MatchStatus.COMPLETED; // Double bye?
                }
                yield db_1.prisma.match.update({
                    where: { id: match.id },
                    data: updateData
     ...
     */
    static generateRoundRobin(event, registrations) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield db_1.prisma.match.createMany({
                data: matches
            });
